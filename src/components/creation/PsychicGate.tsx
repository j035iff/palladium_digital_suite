  ...
  return (
    ...
    <section className="w-full" aria-labelledby="forge-tab-page-heading">
      ...
      >
        ...
        Choose psionic potential (psychic_gate.md). Minor I.S.P. is{' '}

        <strong>M.E. + 2D6 (+1D6/level)</strong>; Major is{' '}

        <strong>M.E. + 4D6 (+1D6+1/level)</strong>. Power picks are made on the{' '}

        <strong>Abilities</strong> tab — Minor: 2 from one category; Major: choose 8 from one

        category or 6 mixed across Sensitive, Physical, and Healing. Major tier applies a{' '}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul
                ...
                aria-label="Psychic Gate percentile ranges"
          ...
          <div className={`space-y-4 rounded-md border p-4 ${subStyle}`}>
            ...
            >
              ...
              <p className="mt-2 text-xs opacity-80">
                ...
                {tierChosen && psychicGateIspFormulaHint(psychicTier)

                  ? ` (${psychicGateIspFormulaHint(psychicTier)}; M.E. ${activeFormState.attributes.me} + roll)`
