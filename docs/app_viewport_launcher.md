...
5. Hub landing: Story / Combat master tabs (sheet analogue). **Open Session** is in the hub header under **Return to launcher**. Story Home is Sessions (scratchpad, conversion rules). Combat Home is the combat HUD. Party, Cast, and Gear sit under both modes. Full hub: [gm_hub.md](./gm_hub.md).
