  ...
  └─ app_viewport_launcher.md     Open Character | Create Character
        └─ forge/character_creation.md   (Create only) 9-tab Forge (leads with Identity)
              ...
              └─ universal_forge_navigation_engine.md   Continue, colors, yellow/red
                    └─ character_spawn_handoff.md   Tab 9 confirm → live sheet
```
...
| [forge/character_creation.md](./forge/character_creation.md) | Forge tab sequence (leading Identity tab + step tabs through Gear + Review), alignment Tab 1 vs 9, conflict/yellow rules |
